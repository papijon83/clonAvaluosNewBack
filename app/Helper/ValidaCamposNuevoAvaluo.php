...
function valida_AvaluoDescripcionImueble($data, $elementoPrincipal, $datad = false, $b_6 = false){
    ...
    if($elementoPrincipal == '//Comercial'){
        //$validacionese = array('UsoActual' => 'nonEmptyString_2000', 'VidaUtilTotalPonderadaDelInmueble' => 'nullableDecimalPositivo', 'EdadPonderadaDelInmueble' => 'nullableDecimalPositivo', 'VidaMinimaRemanentePonderadaDelInmueble' => 'nullableDecimalPositivo');
